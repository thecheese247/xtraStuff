...
and password or clicked 'Add another question' on the
confirmation page, Confirmation.php
*/
	$Progress=TRUE;
/*initially $Progress is set to TRUE*/
	if	(isset($_POST['Submit']))
	{
/*
if the user has submitted a username and password then the
system checks whether or not the login is valid otherwise
the add question screen is displayed
*/
