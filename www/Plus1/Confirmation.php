...
/*	********************************************* 
	...
	*********************************************
	...
	the user to return to the topic screen and also
...
<DIV CLASS='Body'>
	<H1>Your question has been added, click return to return to the topic slection screen
		or click add another question if you want to add another question
	</H1>
	<br>
</DIV>
<!--
...
them to click return or Add another question if they want to
...
<!--
Another button, placed using 'right' and formatted using 'button',
is placed onscreen that allows the user to add another question
-->
	</FORM>
	</DIV>
</DIV>
