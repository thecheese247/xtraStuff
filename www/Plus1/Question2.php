...
/*
The variables, $TopicID, $Score and $Qnumber are acquired from the
previous page and $Qnumber is incremented by 1
*/
...
using the bottom tag, and has alternate text 'Addem talking'
-->	
		</BODY>
		</HTML>
		";
